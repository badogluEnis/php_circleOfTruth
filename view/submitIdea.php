...
<textarea name ="antwkorr" id="antwkorr" rows="1" cols="25" placeholder="Korrekte Antowrt" style="resize:none" required></textarea>
...
<p>* Moralfrage bedeutet, dass es keine richtige Antwort gibt.</p>
